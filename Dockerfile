...
RUN echo 'whoami ' >>/lee.sh
RUN echo 'cd ' >>/lee.sh
RUN echo "su -l -c  'vncserver :2000 -geometry 1280x800' "  >>/lee.sh
RUN echo 'cd /noVNC-1.2.0' >>/lee.sh
RUN echo './utils/launch.sh  --vnc localhost:7900 --listen 8900 ' >>/lee.sh
RUN chmod 755 /lee.sh
EXPOSE 8900
CMD  /lee.sh
